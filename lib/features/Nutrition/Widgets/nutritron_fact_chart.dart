...
class NutritionFactsChartWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final data = macros.entries
        .map((e) => _MacroData(e.key, e.value))
        .toList();
          ...
          SfCircularChart(
            ...
            series: <PieSeries<_MacroData, String>>[
              PieSeries<_MacroData, String>(
                ...
                '${data.name}: ${data.value.toStringAsFixed(1)}g',
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          // Header
          Text("Nutrition Facts", style: Theme.of(context).textTheme.headlineMedium),
