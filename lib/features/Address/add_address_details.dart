...
class AddAddressDetails extends StatefulWidget {
  ...
  const AddAddressDetails({super.key, required this.selectedAddress, required this.userName, required this.phoneNumber, required this.isCurrentAddress, required this.locationController});
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(
                      height: THelperFunctions.screenHeight(context) * 0.1),
                ],
              ),
            ),
          ),
