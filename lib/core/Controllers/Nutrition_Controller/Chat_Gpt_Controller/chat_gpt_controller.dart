...
// import 'package:conquest/core/Controllers/recipe_controller.dart';
...
//     calories.value =
//         userController.userModel.value?.calorieGoal?.toDouble() ?? 500.0;
//   }
//
//   void _setMealType() {
...
class RecipeRecommendationChatGptController extends GetxController {
  ...
  void _initializeUserData() {
    final userController = UserController.instance;
    var diets = userController.userModel.value?.dietPreference ?? ['Vegetarian'];
    selectedDiet.value = diets.join(', ');
    calories.value =
