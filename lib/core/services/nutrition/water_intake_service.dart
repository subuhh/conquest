  ...
  Future<WaterIntakeModel?> getWaterIntake(String userId, DateTime date) async {
    try {
      final docRef = _firestore
          ...
          .doc(userId)
          .collection('waterIntake') // Water intake sub-collection
          .doc(date.toIso8601String()); // Use date as document ID
  ...
  Future<void> setWaterIntake(
    ...
    try {
      final docRef = _firestore
          ...
          .doc(userId)
          .collection('waterIntake') // Water intake sub-collection
          .doc(waterIntake.date.toIso8601String()); // Use date as document ID
